# Installing / upgrading to v0.10.16

v0.10.16 is the second batch of robustness fixes from the external review.
...
```
docs/CHANGELOG_v0.10.16.md
docs/INSTALL_v0.10.16.md
CHANGELOG.md
README.md
...
- The service worker will refresh the Studio UI once (cache bumped to
  `v0.10.16-1`). If anything still looks stale, hard-refresh with
  Ctrl+Shift+R.
