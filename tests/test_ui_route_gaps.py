...
def test_chat_generate_400_on_generation_error(tmp_path: Path) -> None:
    ...
    def failing_generate(checkpoint, prompt, *, max_new_tokens, temperature, top_k, top_p=1.0, repetition_penalty=1.15, device_name="auto", task_format=False, strict_context=False):
